...
const boardOutputPath = path.join(root, 'outputs/index.html');
...
html = html.replace(/<div id="map"><\/div>\r?\n<div class="tabs" id="tabs"><\/div>\r?\n<div class="content" id="content"><\/div>/, '<main class="trip-layout"><section class="content-pane" aria-label="地点、日期与行程时间轴"><div class="top-nav"><div class="tabs place-tabs" id="tabs"></div><a class="page-switch" href="index.html">🏨 住宿选择</a></div><section class="content" id="content"></section></section><aside class="map-pane" aria-label="行程地图"><div id="map"></div></aside></main>');
